 ...
 * 2017-12-05T16:19:22.625+03:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "MeasurerCargo", 
                  wsdlLocation = "http://lk-test.cse.ru/cse8_alexey/ws/MeasurerCargo?wsdl",
...
public class MeasurerCargo extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://lk-test.cse.ru/cse8_alexey/ws/MeasurerCargo?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MeasurerCargo.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://lk-test.cse.ru/cse8_alexey/ws/MeasurerCargo?wsdl");
        }
        WSDL_LOCATION = url;
    }

 ...
 * 2017-12-25T14:19:00.227+03:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "MeasurerCargo", 
                  wsdlLocation = "http://web.cse.ru/cse82_reg/ws/MeasurerCargo?wsdl",
...
public class MeasurerCargo extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://web.cse.ru/cse82_reg/ws/MeasurerCargo?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MeasurerCargo.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://web.cse.ru/cse82_reg/ws/MeasurerCargo?wsdl");
        }
        WSDL_LOCATION = url;
    }

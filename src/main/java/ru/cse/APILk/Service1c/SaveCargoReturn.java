 ...
 *         &lt;element name="ReturnToOffice" type="{http://www.w3.org/2001/XMLSchema}boolean"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SaveCargoReturn")
public class SaveCargoReturn {
    ...
    @XmlElement(name = "ReturnToOffice", required = true, type = Boolean.class, nillable = true)
    protected Boolean returnToOffice;
    ...
    /**
     * Gets the value of the returnToOffice property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the returnToOffice property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setReturnToOffice(Boolean value) {
        this.returnToOffice = value;
    }

 ...
 * 2017-12-21T09:56:43.588+03:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "SorterExchange", 
                  wsdlLocation = "http://lk-test.cse.ru/cargo3_test/ws/SorterExchange?wsdl",
...
public class SorterExchange extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://lk-test.cse.ru/cargo3_test/ws/SorterExchange?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SorterExchange.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://lk-test.cse.ru/cargo3_test/ws/SorterExchange?wsdl");
        }
        WSDL_LOCATION = url;
    }

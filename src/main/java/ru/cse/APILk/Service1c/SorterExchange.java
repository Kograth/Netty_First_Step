...
public class SorterExchange extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://web.cse.ru/cse8_bsp/ws/SorterExchange?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SorterExchange.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://web.cse.ru/cse8_bsp/ws/SorterExchange?wsdl");
        }
        WSDL_LOCATION = url;
    }
